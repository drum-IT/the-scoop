...
function createComment(url, request) {
  ...
  if (requestComment && requestComment.body && requestComment.articleId && database.users[requestComment.username] && database.articles[requestComment.articleId]) {
    const newComment = {
...
function loadDatabase() {
  const data = yaml.readSync('./database.yaml');
  return data;
}
